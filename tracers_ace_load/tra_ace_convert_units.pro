;+
;PROCEDURE: 
;	TRA_ACE_CONVERT_UNITS
;PURPOSE: 
;	Convert the units for an ACE 3d data structure 
...
;	Jasper Halekas
;CALLING SEQUENCE: 
;	TRA_ACE_CONVERT_UNITS, Data, Units, SCALE=SCALE
;INPUTS: 
;	Data: A 3d data structure for ACE
...
pro tra_ace_convert_units, data, units, scale=scale
